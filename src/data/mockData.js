...
export const CAREERS = [
  {
    ...
    demand: 'Very High',
    demandLevel: 5,
    skills: ['JavaScript', 'TypeScript', 'React', 'Node.js', 'Express', 'MongoDB', 'HTML', 'CSS', 'Git', 'SQL'],
  ...
  },
  {
    ...
    demand: 'High',
    demandLevel: 4,
    skills: ['Python', 'SQL', 'Pandas', 'NumPy', 'Scikit-Learn', 'Statistics', 'Machine Learning', 'Data Visualization'],
  ...
  },
  {
    ...
    demand: 'High',
    demandLevel: 4,
    skills: ['Figma', 'User Research', 'Prototyping', 'Accessibility', 'Design Systems', 'HTML', 'CSS'],
    requiredSkills: ['Figma', 'User Research', 'Prototyping', 'Accessibility', 'Design Systems', 'HTML', 'CSS'],
    icon: '🎨',
  },
  {
    id: 'pm',
    ...
    demand: 'High',
    demandLevel: 4,
    skills: ['Product Strategy', 'Roadmapping', 'Data Analysis', 'Agile', 'User Research', 'SQL'],
    requiredSkills: ['Product Strategy', 'Roadmapping', 'Data Analysis', 'Agile', 'User Research', 'SQL'],
    icon: '📈',
  },
  {
    id: 'devops',
    ...
    demand: 'Very High',
    demandLevel: 5,
    skills: ['Linux', 'Docker', 'Kubernetes', 'CI/CD', 'AWS', 'Terraform', 'Python', 'Bash', 'Git', 'SQL'],
    requiredSkills: ['Linux', 'Docker', 'Kubernetes', 'CI/CD', 'AWS', 'Terraform', 'Python', 'Bash', 'Git', 'SQL'],
    icon: '🚀',
  },
  {
    id: 'cyber',
